...
public class InfrastructureTest {
    ...
    @ArchTest
    static final ArchRule infrastructure =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_in_rest =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_in_notification =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_out_persistence_converter =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_out_persistence_entity =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_out_persistence_repository =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_out_scheduler =
            classes()
    ...
    @ArchTest
    static final ArchRule adapter_out =
            classes()
    ...
    @ArchTest
    static final ArchRule config_mapper =
            classes()
    ...
    @ArchTest
    static final ArchRule config_yaml =
            classes()
