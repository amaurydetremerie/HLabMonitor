...
class PostgresSqlTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        registry.add("database.type", () -> "postgresql");
        ...
        registry.add("database.host", postgres::getHost);
        registry.add("database.port", () -> postgres.getMappedPort(5432));

        registry.add("monitoring.http.local.target", () -> "http://127.0.0.1:59815/actuator/health");
    }
